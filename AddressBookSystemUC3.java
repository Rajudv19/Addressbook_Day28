...
public class AddressBookSystemUC3 {
	...
	AddressBookSystemUC3(String firstName, String lastName, String address, String state, int zip, long phoneNumber, String eMail ){
		...
		public static void main(String[] args) {
			...
			do {
				...
				case 1:
					...
					c.add(new AddressBookSystemUC3(firstName, lastName, address, state, zip, phoneNumber, eMail));
					break;
				case 2:
				...
				case 3:
					...
					ListIterator<AddressBookSystemUC3> li = ((ArrayList<AddressBookSystemUC3>) c).listIterator();
					while(li.hasNext()) {
						AddressBookSystemUC3 e = li.next();
						if(e.getPhoneNumber() == phoneNumber) {
							...
							eMail = scan.nextLine();
							li.set(new AddressBookSystemUC3(firstName, lastName , address, state, zip, phoneNumber, eMail));
							found = true;
						}
					}
					if(!found) {
