...
public class AddressBookSystemUC10 {
	...
	AddressBookSystemUC10(String firstName, String lastName, String address, String state, int zip, long phoneNumber, String eMail ){
	...
	class Addressbook {
		public void main(String[] args) {
			...
			Collection<AddressBookSystemUC10> c = new ArrayList<AddressBookSystemUC10>();
			Collection<AddressBookSystemUC10> c1 = new ArrayList<AddressBookSystemUC10>();
			...
			do {
				...
				case 1:
					...
					Iterator<AddressBookSystemUC10> i = c.iterator();
					while(i.hasNext()) {
					...
					if(opt == 1) {
						c.add(new AddressBookSystemUC10(firstName, lastName, address, state, zip, phoneNumber, eMail));
					}
					if(opt == 2) {
						c1.add(new AddressBookSystemUC10(firstName, lastName, address, state, zip, phoneNumber, eMail));
					}
					break;
				case 2:
					System.out.print("1.Book_1 \n2.Book_2 \nChoose the Address Book : ");
				...
				case 3:
					...
					if(opt == 1) {
						...
						phoneNumber =  scan1.nextLong();
						ListIterator<AddressBookSystemUC10> li =  ((ArrayList<AddressBookSystemUC10>) c).listIterator();
						while(li.hasNext()) {
							AddressBookSystemUC10 e = li.next();
							if(e.getPhoneNumber() == phoneNumber) {
								...
								eMail = scan.nextLine();
								System.out.print("1.Book_1 \n 2.Book_2 \n Choose the Address Book : ");
								li.set(new AddressBookSystemUC10(firstName, lastName , address, state, zip, phoneNumber, eMail));
								found = true;
							}
						}
					}
					if(opt == 2) {
						System.out.print("Enter the Phone Number to Edit the contact: ");
						phoneNumber =  scan1.nextLong();
						ListIterator<AddressBookSystemUC10> li =  ((ArrayList<AddressBookSystemUC10>) c1).listIterator();
						while(li.hasNext()) {
							AddressBookSystemUC10 e = li.next();
							if(e.getPhoneNumber() == phoneNumber) {
								System.out.print("Enter new First Name : ");
				...
				case 5:
					...
					state = scan.nextLine();
					i = c.iterator();
					Iterator<AddressBookSystemUC10> i1 = c1.iterator();
